...
class Category
{
     ...
     * Add children
     *
     * @param Alvarez\DevAddictionBundle\Entity\Category $children
     */
    public function addChildren(\Alvarez\DevAddictionBundle\Entity\Category $children)
    {
     ...
     * Add stores
     *
     * @param Alvarez\DevAddictionBundle\Entity\Store $stores
     */
    public function addStores(\Alvarez\DevAddictionBundle\Entity\Store $stores)
    {
        $this->stores[] = $stores;
    }
